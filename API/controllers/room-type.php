<?php
    ...
    include_once "../services/room-type.php";
    ...
    switch($method){
        case 'GET':
            if(isset($_GET['id'])){
                sendCode(SUCCESS_CODE, 'Data recovered successfully', json_encode(getRoomTypeById($_GET['id'])));
            }else{
                sendCode(SUCCESS_CODE, 'Data recovered successfully', json_encode(getAllRoomTypes()));
            }
            break;
        case 'POST':
            $json_data = file_get_contents("php://input");
            $json = json_decode($json_data, true);
            $create = createRoomType($json);
            if ($create) {
